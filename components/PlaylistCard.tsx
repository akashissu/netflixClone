...
export default function PlaylistCard({ playlist }: PlaylistCardProps) {
  return (
    <Link
      ...
      className="group bg-spotify-gray hover:bg-white/20 rounded-lg p-4 transition-colors cursor-pointer block"
    >
      ...
      <p className="text-spotify-lightgray text-xs line-clamp-2">{playlist.description}</p>
    </Link>
  );
}
