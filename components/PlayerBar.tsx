...
export default function PlayerBar() {
  const [currentTrack] = useState<Track>(SAMPLE_TRACKS[0]);
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-spotify-gray border-t border-white/10 px-4 py-3">
      <div className="flex items-center justify-between max-w-screen-2xl mx-auto">
        ...
        <div className="flex items-center gap-3 w-1/4 min-w-0">
          ...
          <button
            onClick={toggleLike}
            className={`hidden sm:block flex-shrink-0 transition-colors ${
        ...
        <div className="hidden md:flex items-center gap-2 w-1/4 justify-end">
          ...
          <div className="w-24">
            <input
              ...
              style={{
                background: `linear-gradient(to right, #ffffff ${volume}%, #535353 ${volume}%)`,
              }}
            />
          </div>
        </div>
